...
//        }
        ...
        try {
            return storageProvider.getRecurringJob(id);
        } catch (JobRunrException jobRunrException) {
            jobRunrException.printStackTrace();
        }

        return null;
    }

    public void deleteJobs(StateName stateName, Instant updatedBefore) {
        storageProvider.deleteJobsPermanently(stateName, updatedBefore);
    }
